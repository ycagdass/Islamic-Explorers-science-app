...
class AppState extends ChangeNotifier {
  ...
  Future<void> init() async {
    ...
    final data = await _storageService.getScientists();

    if (data != null && data.isNotEmpty) {
      _scientists = data;
    } else {
      _loadDefaultScientists();
      await _saveScientists();
    }
    _isLoading = false;
    notifyListeners();
  }
  ...
  void _loadDefaultScientists() {
    _scientists = [
      ...
      Scientist(
        ...
        audioUrl:
            'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', // Dummy audio
      ),
      Scientist(
        id: '3',
        name: 'İbn-i Sina',
        ...
        audioUrl:
            'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', // Dummy audio
      ),
      Scientist(
        id: '4',
        name: 'Uluğ Bey',
        ...
        audioUrl:
            'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', // Dummy audio
      ),
      Scientist(
        id: '5',
        name: 'Cahit Arf',
        ...
        audioUrl:
            'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', // Dummy audio
      ),
    ];
  }
}
